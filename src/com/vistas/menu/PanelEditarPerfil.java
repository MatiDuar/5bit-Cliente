				...
				try {
					...
					if (input == 0) {
						...
						if (!apellido1.matches("^[a-zA-Z]+$")) {
							throw new Exception(
									"El campo primer apellido no puede ser vacío y debe contener solo letras.");
						}
						...
						if (!apellido2.isEmpty()) {
							if (!apellido2.matches("^[a-zA-Z]+$")) {
								throw new Exception(
										"El campo segundo apellido no puede ser vacío y debe contener solo letras.");
							}
						}
						...
						if (!nombre1.matches("^[a-zA-Z]+$")) {
							throw new Exception(
									"El campo primer nombre no puede ser vacío y debe contener solo letras.");
						}
						...
						if (contrasena.length() > 50 || contrasena.length() < 8) {
							throw new Exception("El campo contrase�a debe tener entre 8 y 50 caracteres.");
						}
						...
						if (doc.length() != 8 || doc == "        " || !esNumerico(doc)) {
							...
							throw new Exception("Formato de documento inv�lido, debe contener 8 d�gitos numericos sin puntos ni comas");
